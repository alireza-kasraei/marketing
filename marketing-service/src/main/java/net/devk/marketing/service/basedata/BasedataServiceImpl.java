...
class BasedataServiceImpl implements BasedataService {
    ...
    @Autowired
    private SupplyStatusTypeRepository supplyStatusTypeRepository;
    ...
    @Override
    public SupplyStatusType findSupplyTypeByCode(String code) {
        return supplyStatusTypeRepository.findByCode(code);
    }
