...
Insert into PERSONNELS (ID,PERSONNEL_NAME,REGISTER_DATE,USER_NAME,ORGAN_ID) values (3,'پشمک',to_timestamp('24-JAN-19 03.27.51.293000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'pashmak',2);
...
Insert into TARGETS (ID,START_DATE,DUE_DATE,TARGET_NAME,REGISTER_DATE,TARGET_VALUE,ORGAN_ID,SERVICE_ID,VALUE_TYPE_ID,DAYS_COUNT) values (1,to_timestamp('31-DEC-19 03.22.23.546000000 PM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('31-DEC-19 03.22.23.546000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'جذب سرمایه',to_timestamp('23-JAN-19 03.23.19.537000000 PM','DD-MON-RR HH.MI.SSXFF AM'),100000000000,2,1,1,180);
Insert into TARGETS (ID,START_DATE,DUE_DATE,TARGET_NAME,REGISTER_DATE,TARGET_VALUE,ORGAN_ID,SERVICE_ID,VALUE_TYPE_ID,DAYS_COUNT) values (2,to_timestamp('26-DEC-19 03.41.35.490000000 PM','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('26-DEC-19 03.41.35.490000000 PM','DD-MON-RR HH.MI.SSXFF AM'),'اعطای تسهیلات مضاربه',to_timestamp('23-JAN-19 03.42.11.674000000 PM','DD-MON-RR HH.MI.SSXFF AM'),800000000,2,2,1,60);

Insert into TARGETS_MEMBERS (ID,TARGET_MEMBER_VALUE,DUE_DATE,TARGET_MEMBER_NAME,REGISTER_DATE,TARGET_ID,VALUE_TYPE_ID,TEAM_MEMBER_ID) values (1,50000000000,to_timestamp('28-DEC-19 03.26.51.064000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null,to_timestamp('23-JAN-19 03.27.17.701000000 PM','DD-MON-RR HH.MI.SSXFF AM'),1,1,2);
Insert into TARGETS_MEMBERS (ID,TARGET_MEMBER_VALUE,DUE_DATE,TARGET_MEMBER_NAME,REGISTER_DATE,TARGET_ID,VALUE_TYPE_ID,TEAM_MEMBER_ID) values (2,400000000,to_timestamp('18-OCT-19 03.43.12.425000000 PM','DD-MON-RR HH.MI.SSXFF AM'),null,to_timestamp('23-JAN-19 03.43.25.722000000 PM','DD-MON-RR HH.MI.SSXFF AM'),2,1,2);
